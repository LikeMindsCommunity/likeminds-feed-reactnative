...
import { LMButtonProps, LMIconProps } from '../../../uiComponents';

export interface LMDocumentProps {
  attachments: Array<LMAttachmentViewData>; // this represents the array of document attachments to be displayed
